...
<fo:block>Zuzana Schwarzová</fo:block>
</fo:block>
</fo:block>
</fo:block>
</fo:block>
...
<fo:block space-before.optimum="1em" space-before.minimum="0.8em" space-before.maximum="1.2em">Mojou prácou bolo postarať sa o testovacie súbory do nášho programu a o dokumentáciu k projektu.</fo:block>
<fo:block space-before.optimum="1em" space-before.minimum="0.8em" space-before.maximum="1.2em">Testovacie súbory som vytvorila pomocou zoznamu slov, zoznamu cudzích slov a zoznamu zvierat nájdených na internete. Jednotlivé slová museli byť uložené každé v novom riadku textového súboru, pričom prvý riadok textového súboru obsahuje názov kategórie, ktorú budú následne anotátori značkovať. Tento textový súbor som potom poslala nášmu hlavnému programátorovi.</fo:block>
<fo:block space-before.optimum="1em" space-before.minimum="0.8em" space-before.maximum="1.2em">Dokumentáciu projektu som spravila na Githube, pozostáva z vysvetlenia čo náš program robí, návodu na použitie a zo správ jednotlivých členov tímu. Správy bolo poterbné prekonvertovať z xml súboru do pdf.</fo:block>
</fo:block>
</fo:flow>
</fo:page-sequence>
</fo:root>
