...
<fo:block>Matúš Hromádka</fo:block>
</fo:block>
</fo:block>
</fo:block>
</fo:block>
...
<fo:block space-before.optimum="1em" space-before.minimum="0.8em" space-before.maximum="1.2em">Na starosti som mal vytvorenie Javascriptu k nášmu projektu.</fo:block>
<fo:block space-before.optimum="1em" space-before.minimum="0.8em" space-before.maximum="1.2em">Javascript bolo potrebné vytvoriť k HTML stránke, ktorá umožnila značkovanie jednotlivých slov. Stránka pozostáva z niekoľkých tlačítok.</fo:block>
<fo:block space-before.optimum="1em" space-before.minimum="0.8em" space-before.maximum="1.2em">Zelené tlačítko "Agree" priradí slovu hodnotu "True" a ukáže užívateľovi nové slovo. Červené tlačítko "Disagree"  priradí slovu hodnotu "False" a taktiež užívate)lovi ukáže nové slovo. Tlačítko "Error" označí slovo za chybné, resp. nevhodné a priradí mu hodnotu "Error". Ešte je tam tlačítko "Help", ktoré vypíše užívateľovi nápovedu a tlačítko "Previous", ktoré užívateľovi umožňuje vrátiť sa o jedno slovo naspäť v prípade že pri značkovaní spravil preklep.</fo:block>
</fo:block>
</fo:flow>
</fo:page-sequence>
</fo:root>
