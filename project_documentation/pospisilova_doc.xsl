...
<fo:block>Lucie Pospíšilová</fo:block>
</fo:block>
</fo:block>
</fo:block>
</fo:block>
...
<fo:block space-before.optimum="1em" space-before.minimum="0.8em" space-before.maximum="1.2em">Mojim podílem bylo vytvoření prezentace a textu na gitpages, rovnako i management našeho tímu.</fo:block>
<fo:block space-before.optimum="1em" space-before.minimum="0.8em" space-before.maximum="1.2em">Náš tím se setkal tři razy na poradě naživo, ostatek jsme řešili přes internet. Na první poradě jsme byli za vedoucím projektu kvůli zadání našeho projektu. Následně jsme vytvořili náš pracovní plán a umístnili ho na gitpages našeho projektu. Naše druhá porada řešila problém bližšího návrhu projektu, rozdělení práce a výběru programovacího jazyka. Rozhodli jsme se pro Python a Javascript. Třetí schůzka už řešila jen závěr projektu.</fo:block>
<fo:block space-before.optimum="1em" space-before.minimum="0.8em" space-before.maximum="1.2em">Prezentaci jsem se rozhodla udělat na základě našich bodů v pláne projektu.</fo:block>
</fo:block>
</fo:flow>
</fo:page-sequence>
</fo:root>
